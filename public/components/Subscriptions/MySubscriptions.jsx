                                        ...
                                        <div className="flex-row">
                                            <div style={{flex: 1}}>
                                                <div className="menu-header-wrapper">
                                                    ...
                                                    <div>
                                                        <div className="title">Summer Menu</div>
                                                ...
                                                <div style={{overflow: 'hidden', marginTop: 24, display: 'flex', justifyContent: 'flex-end'}}>
                                                    ...
                                                    <button style={{marginRight: 0}} className="notification button--action button--action-outline" onClick={this.handleAddSubscription}>Cancel Subscription</button>
                                                </div>
                                            </div>
                                            <div>
                                            </div>
                                        ...
                                        <div className="flex-row">
                                            <div style={{flex: 1}}>
                                                <div className="menu-header-wrapper">
                                                    <img src={`assets/images/menu-icon.png`} />
                                                    <div>
                                                        <div className="title">Winter Menu</div>
                                                        <div className="menu-plan">Plan: Menu du jour</div>
                                                        <div className="active">Active</div>
                                                    </div>
                                                </div>
