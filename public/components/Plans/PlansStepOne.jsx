                                    ...
                                    <div className="content--container global-padding-wrapper branches-container">
                                        <div className="flex-row">
                                            <div style={{flex: 1}}>
                                                    ...
                                                    <div className="branch--contact aside--section contacts--support">
                                                        <div className="global-padding-wrapper">
                                                            <div className="branch--currencies">
                                                                <SubscriptionsEdit menus={menus.map(menu => menu.MenuID)} onChange={this.onChanges}/>
                                                            </div>
                                                            <div className="branch--currencies">
                                                                <BranchMenusEdit menus={menus.map(menu => menu.MenuID)} onChange={this.onChanges}/>
                                                            </div>
                                                            <div className="menu--languages">
                                                                <BranchLanguagesEdit single className="style-7" languages={(originalLanguages && originalLanguages.length > 0) ? originalLanguages.map(language => {if (language.Language) return language.Language}) : []} label="Original Language" name="originalLanguages" onChange={this.onChanges} />
                                                            </div>
                                                            <div className="menu--languages">
                                                ...
                                                <h2 className="asset--subtitle" style={{marginBottom: 14, marginTop: 24}}>
                                                    Menu #2. Winter Menu
                                                </h2>
                                                ...
                                                <div style={{overflow: 'hidden', marginTop: 24}}>
                                                    <button style={{marginRight: 'auto'}} className="notification button--action button--action-outline" onClick={this.handleAddSubscription}>Add another Subscription</button>
                                                </div>
                                            </div>
                                            <div>
                                                <PlanOrder total={"2,090"} onClick={this.handleContinue} />
                                            </div>
                                        </div>
